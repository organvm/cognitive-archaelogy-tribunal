...
from cognitive_tribunal.utils.ui import (
    print_header, print_step, print_success, print_error, console
)
...
Examples:
  ...
  python main.py --ai-conversations /path/to/chatgpt/export --output-dir ./output
    ...
    if args.scan_archives:
        ...
        with console.status("[bold blue]Scanning archives..."):
    ...
    if args.ai_conversations:
        ...
        with console.status("[bold blue]Aggregating AI context..."):
    ...
    if args.personal_repos:
        ...
        try:
            with console.status("[bold blue]Analyzing personal repos..."):
    ...
    if args.org_repos:
        ...
        try:
            with console.status("[bold blue]Analyzing org repos..."):
    ...
    if args.web_bookmarks:
        ...
        with console.status("[bold blue]Analyzing web bookmarks..."):
    ...
    if not args.no_inventory:
        print_step("Generating unified inventory...")
        with console.status("[bold blue]Building inventory..."):
    ...
    if not args.no_graph:
        print_step("Generating knowledge graph...")
        with console.status("[bold blue]Building graph..."):
    ...
    if not args.no_triage:
        print_step("Generating triage report...")
        with console.status("[bold blue]Building report..."):
    ...
    print_success(f"All outputs saved to: {output_dir.absolute()}")
